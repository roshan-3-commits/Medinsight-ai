...
`;
    ...
    const fallbackText = text || `Specimen: ${fileName || 'Blood_Sample.pdf'}\nPatient: Rahul Sharma, Age: 28, Male\nHemoglobin: 10.5 g/dL (Normal 12.0 - 16.0 g/dL)\nFasting Blood Sugar: 95 mg/dL (Normal 70 - 100 mg/dL)\nTotal Cholesterol: 230 mg/dL (Normal < 200 mg/dL)\nVitamin D3: 18 ng/mL (Normal 20 - 50 ng/mL)\nPlatelet Count: 240000 /mcL (Normal 150000 - 450000 /mcL)`;
    const fallbackReport = analyzeLabText(fallbackText, fileName);
